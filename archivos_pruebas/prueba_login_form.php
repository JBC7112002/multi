...
<head>
    ...
    <link rel="stylesheet" href="../prueba_logi/assets/css/estilos.css">
</head>
<body>
        ...
        <main>
            ...
            <div class="contenedor__todo">
                ...
                <div class="contenedor__login-register">
                    <!--Login-->
                    <form action="login_prueba.php" method="post" class="formulario__login">
        ...
        <script src="../prueba_logi/assets/js/script.js"></script>
</body>
</html>