...
<?php  /* 
 ...
 // } else {
    ...
    <script>
     ...
     <header>
         <h1 style="padding-right: 5px;" > Multiservi </h1>
        ...
        <p style="padding-right: 20; text-align: center;"> Servicios A la orden </p>
</header>
<?php
 // }
  ?>
    ...
    <div class="container">
      ...
      <h1 style="padding-right: 17px;">Servicios </h1>
            ...
            <script>
                const boton1 = document.getElementById("boton1");
                     boton1.addEventListener("click", function() {
                          window.location.href = "chatt2.php"; // Cambia "nueva_pagina.html" por la URL deseada
                        });
            </script>
            <br>
            <BR></BR>
